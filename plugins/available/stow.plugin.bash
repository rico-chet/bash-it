...
# Check
_command_exists stow || return "${SKIPPED}"
...
# ld
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH:+${LD_LIBRARY_PATH}:}"${STOW_TARGET_DIR}/lib:${STOW_TARGET_DIR}/usr/lib/x86_64-linux-gnu"
