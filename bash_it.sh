...
# Load the global "enabled" directory, then enabled aliases, dotfiles,
# completion, plugins
# "_bash_it_main_file_type" param is empty so that files get sourced in glob order
for _bash_it_main_file_type in "" "aliases" "dotfiles" "plugins" "completion"; do
...
_log_debug "Loading custom aliases, dotfiles, completion, plugins..."
for _bash_it_main_file_type in "aliases" "dotfiles" "completion" "plugins"; do
